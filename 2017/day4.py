...
def part2_isValid(phrase):
	phrase = [ ''.join(sorted(x)) for x in phrase.split()]
	return part1_isValid(' '.join(phrase))

print(sum(map(part1_isValid, input.split('\n'))))
print(sum(map(part2_isValid, input.split('\n'))))
